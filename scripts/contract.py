...
EXPECTED_GRAPH_SHA256 = "ddfbf34f4ab4032f26df0db53c41e21fbb90f04fcfd1608bb7aebd5be7ff2969"
EXPECTED_REGISTRY_SHA256 = "8f7724299410eaae981f8cd0eb61ff28f095eca57c1d05d98b4e63a2aeb20344"
EXPECTED_GATE_ASSERTIONS = {
    ...
    "RS-G04": ["provider-key-absent", "network-denied", "model-not-called", "external-tools-not-called", "failure-reproduced"],
    ...
    "RS-G09": ["k-of-n-bookkeeping", "fresh-trial-isolation", "cache-key-complete", "attempt-report-complete", "probabilistic-label"],
    ...
    "RS-G12": ["clean-checkout", "full-tests", "killer-minimize", "repro-export", "minimality-verify", "terminal-demo-duration"],
}
...
CONTROL_PLANE_FILES = [
    ".agent-state.json", "AGENTS.md", "CODEX_START.txt", "CODEX_TASKS.json", "GATE_REGISTRY.json",
