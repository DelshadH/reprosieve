...
Grouping, alternation, counted repetition, backreferences, and patterns with
more than one quantifier are rejected because Python's standard regular-
expression engine has no evaluation timeout.
