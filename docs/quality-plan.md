...
|---|---|---|
| RS-G13 | Clean Python package bootstrap | CI builds, installs, and smoke-tests wheel/sdist on Python 3.11, 3.12, and 3.13. |
...
| RS-G12 | Release experience | `python scripts/killer_demo.py` performs fixture creation, minimization, verification, export, and reproduction in at most 20 seconds. |
