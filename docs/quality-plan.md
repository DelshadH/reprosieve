...
The gate identifiers are stable so CI output and release evidence can refer to the
same requirements over time. A tiny synthetic ddmin list test is not sufficient
evidence for RS-G05 or RS-G06.
