...
| PR 9: `codex/one-zero-readiness` | current draft head | External-validation and maturity governance; exact-head CI required |
...
permissioned real-case evidence; PRs 8 and 9 do not create that evidence.
...
11. Retarget PRs 7, 8, and 9 onto the new `main` in order. Review and merge
...
- Separate review and disposition of later PRs 7, 8, and 9.
